...
#include "Act1Initialcheck.h"					/// Header for Activity 1
#include "Act2TemperatureSensor.h"				/// Header for Activity 2
#include "Act3PWMoutput.h"			/// Header for Activity 3
#include "Act4USARTdata.h"						/// Header for Activity 4
